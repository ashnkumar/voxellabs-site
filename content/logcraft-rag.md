...
slug: logcraft-rag
title: LogCraft RAG
deck: Field service engineers write long maintenance logs by hand. LogCraft takes a photo and a scribbled note and returns a finished log — using multi-modal retrieval over every log written before it.
year: 2024
...
_**👉🏼 Note:** The LogCraft project is built within a Databricks workspace and requires access to APIs specific to that workspace; please see workspace ID and notebook link in submission materials to access the project._
